...
<div class="page-content">
    ...
    <div class="col-md-8 col-xl-8 middle-wrapper">
        <div class="row">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('update.stats.hours', $stat->id) }}" method="post" class="forms-sample">
                        @csrf
                        @method('PUT')

                        <div class="form-group mb-3 mt-3">
                            <label for="client_search">Select Client</label>
                            <input type="text" name="client_search" id="client_search" class="form-control" placeholder="Search Client" value="{{ $stat->client->name }}" required>
                            <input type="hidden" name="client_id" id="client_id" value="{{ $stat->client_id }}">
                            <div id="client_list"></div>
                        </div>

                        <div class="form-group mb-3 mt-3">
                            <label for="employee_search">Select Employee</label>
                            <input type="text" name="employee_search" id="employee_search" class="form-control" placeholder="Search Employee" value="{{ $stat->employee->name }}" required>
                            <input type="hidden" name="employee_id" id="employee_id" value="{{ $stat->employee_id }}">
                        ...
                        <div class="form-group mb-3 mt-3">
                            ...
                            <select name="labour_id" class="form-select" id="labour_id" required>
                                ...
                                @foreach($labours as $labour)
                                    <option value="{{ $labour->id }}" {{ $stat->labour_id == $labour->id ? 'selected' : '' }}>
                                        {{ $labour->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group mb-3 mt-3">
                            ...
                            <input type="date" name="date" class="form-control" value="{{ $stat->work_date }}" required>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="number" name="rate" id="rate" class="form-control" step="0.01" min="0" value="{{ $stat->rate}}" required>
                            <span class="text-danger">
                                @error('rate')
                                {{$message}}
                                @enderror
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="time" name="check_in_time" id="check_in_time" class="form-control" value="{{ $stat->start_time }}" required>
                            <span class="text-danger">
                                @error('check_in_time')
                                {{$message}}
                                @enderror
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="time" name="check_out_time" id="check_out_time" class="form-control" value="{{ $stat->end_time }}" required>
                            <span class="text-danger">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="number" name="break_time" id="break_time" class="form-control" value="{{ $stat->break_time }}" required>
                            <span class="text-danger">
                                @error('break_time')
                                {{$message}}
                                @enderror
                        ...
                        <button type="submit" class="btn btn-primary">Update Stat Hours</button>
                    </form>
                </div>
            </div>
        </div>
